...
namespace PharmaCheck.Models
{
    ...
    public class InteractionManagementViewModel
    {
        ...
        // ===== Tham số tìm kiếm và lọc cho Tương tác Thuốc =====
        ...
        // ===== Tham số tìm kiếm và lọc cho Chống chỉ định Thuốc-Bệnh =====
    ...
    public class DrugInteractionDisplayDto
    {
        ...
        /// <summary>
        /// Lấy class CSS cho badge mức độ nghiêm trọng
        /// </summary>
    ...
    public class DrugDiseaseContraindicationDisplayDto
    {
        ...
        /// <summary>
        /// Lấy class CSS cho badge mức độ rủi ro
        /// </summary>
